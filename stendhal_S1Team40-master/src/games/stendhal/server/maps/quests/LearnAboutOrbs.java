...
public class LearnAboutOrbs extends AbstractQuest {
	...
	ChatCondition hasInteractedWithOrb = new QuestStateStartsWithCondition("learn_scrying_interaction", "interacted");
	...
	private void step1() {
		...
		// player claims to have interacted with the orb but hasn't
		npc.add(ConversationStates.QUESTION_1,
			ConversationPhrases.YES_MESSAGES, 
			new NotCondition(hasInteractedWithOrb),
			ConversationStates.QUEST_OFFERED,
			"Are you sure? It doesn't seem like you've interacted with the orb. Try again.",
			null);
